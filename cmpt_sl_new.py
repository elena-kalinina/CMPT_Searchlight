...
subj_data_perm_1=[0]*n_of_subj
subj_data_perm_2=[0]*n_of_subj
...
for subj in range(0, n_of_subj): 
    ...
    subj_data_perm_1_1[subj]=concat_imgs(nib.load(os.listdir(permdatapath)[k]) for k in range(0, len(os.listdir(permdatapath))) if re.match(SubjName[subj] , k) and re.match('Perc', k) and re.match('cond0', k))
    subj_data_perm_2_1[subj]=concat_imgs(nib.load(os.listdir(permdatapath)[k]) for k in range(0, len(os.listdir(permdatapath))) if re.match(SubjName[subj] , k) and re.match('Im', k) and re.match('cond0', k))
    subj_data_perm_1_2[subj]=concat_imgs(nib.load(os.listdir(permdatapath)[k]) for k in range(0, len(os.listdir(permdatapath))) if re.match(SubjName[subj] , k) and re.match('Perc', k) and re.match('cond1', k))
    subj_data_perm_2_2[subj]=concat_imgs(nib.load(os.listdir(permdatapath)[k]) for k in range(0, len(os.listdir(permdatapath))) if re.match(SubjName[subj] , k) and re.match('Im', k) and re.match('cond1', k))
